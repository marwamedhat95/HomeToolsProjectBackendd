...
    const res = await axios.get("https://localhost:5000/api/videos");
    setVideos(res.data);
  };
...
                  {v.type === "file" && (
                    <video
                      src={`https://localhost:5000/uploads/videos/${v.filename}`}
...
                <video
                  src={`https://localhost:5000/uploads/videos/${selectedVideo.filename}`}
                  controls
                  autoPlay
